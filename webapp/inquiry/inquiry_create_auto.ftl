...
<@layout.mbl_layout "${(title)!'--'}", 'view-ir'>
    ...
    <#assign inqStatus = 13>
    <#assign costStatus = Inquiry.costStatus>
...
<div class="col-md-12">
    <div class="card strpied-tabled-with-hover">
        <div class="card-header ">
            <h4 class="card-title">${(Inquiry.inqNo)!'--'}</h4>

            <span class="card-category"><b>${(Inquiry.custId)!'--'} : ${(Inquiry.custName)!'--'}</b></span>
        </div>
                ...
                <div class="col-md-12">
                    <table id="inquiry-table" class="" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="se-value-l copy-me" width="30%">${(Inquiry.custName)!'--'}</td>
                            <td class="se-label-r" width="20%">Request Date</td>
                            <td class="se-value-l copy-me"
                                width="100%">${(Inquiry.requestDate?string('dd/MM/yyyy'))!'--'}</td>
                        </tr>
                        <tr>
                            <td class="se-label-r">Master Customer ID</td>
                            <td class="se-value-l copy-me">${(Inquiry.custId)!'--'}</td>
                            <td class="se-label-r">Branch Code</td>
                            <td class="se-value-l copy-me" width="100%">${(Inquiry.brCode)!'--'}</td>
                        </tr>
                        <tr>
                            <td class="se-label-r">Inquiry Type</td>
                            <td class="se-value-l copy-me">New</td>
                            <td class="se-label-r">Type of Financing</td>
                            <td class="se-value-l copy-me" width="100%">${''}</td>
                        </tr>
                        <tr>
                            <td class="se-label-r">Repay Mode ${(ISP.STATUS)!}</td>
                            <td class="se-value-l copy-me">Installment</td>
                            <td class="se-label-r">No of Installment</td>
                            <td class="se-value-l copy-me" width="100%">${'35'}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="se-value-l copy-me" width="100%">
                                Debited<br>
                                <span style="font-weight: normal; font-size: 11px">Debit Trans. ID - 21541245421</span>
                    ...
                    <div class="row" id="subject-data-col-${(sd.custId)!'--'}"
                        ...
                        <table id="data-table" class="" width="100%">
                            ...
                            <tr>
                                ...
                                <td class="se-label-r">Street Name</td>
                                <td class="se-value-l copy-me">${(sd.permanentAddress)!'--'}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="se-label-r">Street Name</td>
                                <td class="se-value-l copy-me">${(sd.presentAddress)!'--'}</td>
                            </tr>
                            <tr>
                                <td class="se-label-r">Post Code</td>
                            ...
                            <!--Company : Business Address-->
                                ...
                                <tr>
                                    ...
                                    <td class="se-label-r">Street Name</td>
                                    <td class="se-value-l copy-me">${(sd.businessAddress)!'--'}</td>
                                </tr>
                                <tr>
                                    <td class="se-label-r">Post Code</td>
            ...
            <div class="card-body table-full-width table-responsive">
                <div class="col-md-12 text-right">
                    ...
                    <#if inqStatus = INQ_STATUS_CREATED || ((inqStatus = INQ_STATUS_PROCESSING || inqStatus = INQ_STATUS_FORWARDED)) && isCibOperator>
                        <input type="button" id="complain-obj" style="" class="btn btn-sm btn-success pointer op-btn"
